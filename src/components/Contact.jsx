    ...
    return (
        ...
        data-aos-duration="3000">
            ...
            <div className="text-center  ">
                    ...
                    <p className='flex items-center gap-3 '><SlEnvolope></SlEnvolope> Email: <a href="mailto:kayesmahmud2220@gmail.com" target="_blank" className=" underline hover:text-accent"> kayesmahmud2220@gmail.com</a></p>
                    <p className='flex items-center gap-3 ' ><IoCall /> Phone: <a href="tel:+8801729527377" target="_blank" className="hover:text-accent">+8801892549812</a></p>
